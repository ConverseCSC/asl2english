...
//var newsigns = JSON.parse(ASLarraystripped);

//console.log(newsigns[0]);
//var signs = [];

//$.getJSON("multivideosigns.json", function(signobjects) {
	
//	console.log(signobjects[0]);
  //  signs.push(signobjects);
    // signs is a JavaScript object now. Handle it as such
