...
sideregions = { 'image': 'images/side.svg',
		...
		'regions': {
		    ...
		    'forehead': {'elt': 'path', 'xyz': [0, 6],
				 'd': 'M 45 40 L 60 45 60 55 45 55 z' },
		    'Eye': {'elt': 'ellipse', 'c': [57, 62], 'r': [6, 5],
			      'xyz': [-1, 5]},
		   // 'L-eye': {'elt': 'ellipse', 'c': [66, 43], 'r': [6, 5],
			 //     'xyz': [1, 5]},
		    'Cheek': {'elt': 'ellipse', 'c': [53, 72], 'r': [6, 7],
				'xyz': [-2, 3]},
		    //'L-cheek': {'elt': 'ellipse', 'c': [73, 56], 'r': [6, 7],
			//	'xyz': [2, 3]},
		    'nose':  {'elt': 'ellipse', 'c': [65, 75], 'r': [7, 6],
			      'xyz': [0, 4]},
		    'mouth': {'elt': 'path', 'xyz': [0, 3],
			      'd': 'M 45 78 L 56 78 67 78 67 88 45 88 z' },
		    'chin': {'elt': 'path', 'xyz': [0, 2],
			     'd': 'M 42 88 L 67 88 67 98 42 98 z' },
...
frontregions = { 'image': 'images/front.svg',
		...
		'regions': {
		    ...
		    'above-left-shoulder': {'elt': 'path', 'xyz': [-1, 2],
				       'd': 'M 50 0 L 93 0 93 100 50 130 z' },
			...
			'high-left': {'elt': 'path', 'xyz': [2, 2],
				   'd': 'M 192 0 L 250 0 250 130 192 130 z' },
		    'above-right-shoulder': {'elt': 'path', 'xyz': [1, 2],
				       'd': 'M 200 0 L 160 0 160 100 200 130 z' },
			...
			'right-ear': {'elt': 'ellipse', 'c': [102, 72],
			      'r': [5, 7], 'xyz': [-2, 4, -2] },
			'left-ear': {'elt': 'ellipse', 'c': [153, 72],
			      'r': [5, 7], 'xyz': [-2, 4, -2] },
		    'Forehead': {'elt': 'path', 'xyz': [0, 6],
